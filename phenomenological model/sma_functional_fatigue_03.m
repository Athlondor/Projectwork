...
E_A = 72*10^9; % GPa
E_M = 24*10^9; % GPa
L_ini = 0.079*10^9; % GPa
Y_ini = 0.064*10^9; % GPa/m
theta_0 = 233.15; % K
gamma = 0.001; % N s m^-4
c_m = 5.405 * 10^-3 *10^9; % GPa/K
C_m = 0.1562 *10^9; % GPa/K
...
%     i_lc = i_lc + 1;
%     max_position = max(x_tau_2(cycle,:));  % Maximale Position der Phasenfront im aktuellen Zyklus
